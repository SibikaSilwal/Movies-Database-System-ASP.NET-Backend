...
namespace MoviesAPI.Controllers
{
    ...
    public class ActorsController : ControllerBase
    {
        ...
        private readonly string fileContainerName = "actors";
        ...
        [HttpGet] //api/genres
        public async Task<ActionResult<List<ActorDTO>>> Get([FromQuery] PagginationDTO paginationDTO)
        {
        ...
        public async Task<ActionResult> Post([FromForm] ActorCreationDTO actorCreationDTO)
        {
            ...
            {
                actor.Picture = await fileStorageService.SaveFile(fileContainerName, actorCreationDTO.Picture);
            }
        ...
        public async Task<ActionResult> Put(int id, [FromForm] ActorCreationDTO actorCreationDTO)
        {
            ...
            if(actorCreationDTO.Picture != null)
            {
                actor.Picture = await fileStorageService.EditFile(fileContainerName, actorCreationDTO.Picture, actor.Picture);
            }
        ...
        public async Task<ActionResult> Delete(int id)
        {
            ...
            await context.SaveChangesAsync();
            await fileStorageService.DeleteFile(actor.Picture, fileContainerName);
            return NoContent();
        }
    }
}
